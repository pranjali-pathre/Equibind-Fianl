...
def parse_arguments(arglist = None):
    ...
    dicty["config"] = 'configs_clean/inference.yml'
    dicty["checkpoint"] = None
    dicty["output_directory"] = None
    dicty["run_corrections"]=False
    dicty['run_dirs'] = []
    dicty['fine_tune_dirs']=[]
    dicty['inference_path'] = "./data/test"
    dicty['experiment_name'] = "EquiBind"
    dicty['logdir']='runs'
    dicty['num_epochs']=2500
    dicty['batch_size']=1024
    dicty['patience']=20
    dicty['minimum_epochs']=0
    dicty['dataset_params']={}
    dicty['num_train']=-1
    dicty['num_val']=None
    dicty['seed']=1
    dicty['multithreaded_seeds']=[]
    dicty['seed_data']=1
    dicty['loss_func']='MSELoss'
    dicty['loss_params']={}
    dicty['optimizer']='Adam'
    dicty['optimizer_params']
    dicty['clip_grad']=None
    dicty['lr_scheduler']=None
    dicty['lr_scheduler_params']=None
    dicty['scheduler_step_per_batch']=True
    dicty['log_iterations']=-1
    dicty['expensive_log_iterations']=100
    dicty['eval_per_epochs']=0
    dicty['metrics']=[]
    dicty['main_metric']='loss'
    dicty['main_metric_goal']='min'
    dicty['val_per_batch']=True
    dicty['tensorboard_functions']=[]
    dicty['num_epochs_local_only']=1
    dicty['collate_function']='graph_collate'
    dicty['collate_params']={}
    dicty['device']='cuda'
    dicty['models_to_save']=[]
    dicty['model_type']='MPNN'
    dicty['model_parameters']=None
    dicty['trainer']='binding'
    dicty['train_sampler']=None
    dicty['eval_on_test']=True
    dicty['check_se3_invariance']=False
    dicty['num_confs']=1
    dicty['use_rdkit_coords'] = False
